                ...
                <div>
                    ...
                    <div className='flex flex-wrap lg:gap-[50px] gap-[20px] justify-center  pt-[50px]'>
                        <div className=' boxshadow3 cursor-pointer 2xl:basis-[33%] lg:basis-[40%] mdbasis-[48%] basis-full py-[12px] rounded-lg px-[20px]  border'>
                            <Link to="/tools/buinessloan">  <div className='text-[20px] leading-[28px]  font-[500] text-[#1a181e]' >
                        ...
                        <Link to="/tools/barcode">   <div className='  boxshadow3 cursor-pointer 2xl:basis-[33%] lg:basis-[40%] md:basis-[48%] basis-full py-[12px] rounded-lg px-[20px]  border' >
